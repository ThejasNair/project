...
function Emoted_4() {
    document.getElementById("P4Says").style.borderStyle = "ridge";
    document.getElementById("P4Says").style.backgroundColor="white";
    document.getElementById("P4Says").innerHTML = "hahae! me winning :DDDDDDDD";
    setTimeout(ceaseMovement, 5000);
